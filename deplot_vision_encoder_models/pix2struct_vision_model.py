...
class Pix2StructForConditionalGeneration(Pix2StructPreTrainedModel):
    ...
    def __init__(self, config: Pix2StructConfig):
        super().__init__(config)
        #print('My output >> Pix2StructForConditionalGeneration >> type(config.vision_config) : ', type(config.vision_config))
        #print('My output >> Pix2StructForConditionalGeneration >> config.vision_config : ', config.vision_config)
